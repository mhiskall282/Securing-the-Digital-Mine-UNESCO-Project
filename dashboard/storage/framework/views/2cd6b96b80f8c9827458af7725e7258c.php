...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Securing the Digital Mine'); ?> — SaaS Dashboard</title>
...
<body class="h-full flex flex-col bg-[#0c0c0e] text-[#ededef] font-sans antialiased selection:bg-[#10b981]/30 selection:text-white">
    ...
    <nav class="sticky top-0 z-40 bg-[#17171a]/80 backdrop-blur-md border-b border-[#2e2e33]/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-1.5">
                    <a href="<?php echo e(route('dashboard')); ?>"
                       class="px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-200
                              <?php echo e(request()->routeIs('dashboard') ? 'bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        Overview
                    </a>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('live-monitor')); ?>"
                       class="px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-200
                              <?php echo e(request()->routeIs('live-monitor') ? 'bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        Live Monitor
                    </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <a href="<?php echo e(route('research')); ?>"
                       class="px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-200
                              <?php echo e(request()->routeIs('research') ? 'bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        Research & Insights
                    </a>

                    <a href="<?php echo e(route('api-docs')); ?>"
                       class="px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-200
                              <?php echo e(request()->routeIs('api-docs') ? 'bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        API & CLI Docs
                    </a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false"
                                class="px-3.5 py-2 rounded-xl text-xs font-semibold flex items-center gap-1 transition-all duration-200
                                       <?php echo e((request()->routeIs('devices') || request()->routeIs('bwoa') || request()->routeIs('simulator')) ? 'bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                            Tools Console
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <a href="<?php echo e(route('devices')); ?>" class="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/5 transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#10b981]"></span>
                                Device Nodes
                            </a>
                            <a href="<?php echo e(route('bwoa')); ?>" class="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/5 transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                                BWOA Optimizer
                            </a>
                            <a href="<?php echo e(route('simulator')); ?>" class="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/5 transition">
                ...
                <div class="hidden md:flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('settings')); ?>" title="Account Settings"
                       class="p-2 rounded-xl text-xs font-semibold transition-all duration-200
                              <?php echo e(request()->routeIs('settings') ? 'bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20' : 'bg-white/5 text-gray-400 hover:text-white border border-white/10 hover:bg-white/10'); ?>">
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 bg-[#10b981] hover:bg-[#0da672] text-white rounded-xl text-xs font-semibold transition cursor-pointer">
                        Console Login
                    </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-[#2e2e33] bg-[#0c0c0e] px-4 py-4 space-y-2">
            <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">Overview</a>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('live-monitor')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">Live Monitor</a>
            <a href="<?php echo e(route('devices')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">Device Nodes</a>
            <a href="<?php echo e(route('bwoa')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">BWOA Optimizer</a>
            <a href="<?php echo e(route('simulator')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">Detection Simulator</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <a href="<?php echo e(route('api-docs')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">API & CLI Docs</a>
            <a href="<?php echo e(route('research')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-gray-300 hover:bg-white/5">Research</a>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('admin-dashboard')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-red-400 hover:bg-white/5">Admin Panel</a>
            <a href="<?php echo e(route('settings')); ?>" class="block px-4 py-2 rounded-xl text-sm font-semibold text-emerald-400 hover:bg-white/5">Settings & Profile</a>
            ...
            <?php else: ?>
            <div class="border-t border-[#2e2e33] my-2 pt-2">
                <a href="<?php echo e(route('login')); ?>" class="block text-center px-4 py-2 bg-[#10b981] hover:bg-[#0da672] text-white rounded-xl text-sm font-semibold transition">Console Login</a>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </nav>
    ...
    <footer class="border-t border-[#2e2e33] bg-[#0c0c0e] py-6 text-xs text-gray-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
                <span>&copy; <?php echo e(date('Y')); ?> Securing the Digital Mine. Built with Laravel, Livewire, and Tailwind CSS.</span>
            </div>
...
<?php /**PATH C:\Users\user\Desktop\unesco-project\dashboard\resources\views/layouts/app.blade.php ENDPATH**/ ?>