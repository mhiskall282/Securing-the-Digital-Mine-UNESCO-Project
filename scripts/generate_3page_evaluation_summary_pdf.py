...
def build_pdf():
    ...
    story.append(Paragraph('<b>Authors:</b> John Okyere (Lead), Ezekeil Baah, Clement Baffour, Parker Paa Annobil, George Akwesi Bonnah | <b>Affiliation:</b> Dept. of ICT, University of Education, Winneba (UEW), Ghana & Kayaba Labs | <b>Host:</b> Empress Catherine II Saint Petersburg Mining University, Russia', subtitle_style))
